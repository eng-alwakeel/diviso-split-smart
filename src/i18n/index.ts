...
i18n
  ...
  .init({
    ...
    fallbackLng: 'ar',
    defaultNS: 'common',
    ns: ['common', 'settings', 'auth', 'dashboard', 'expenses', 'groups', 'errors', 'faq', 'quota', 'notifications', 'landing', 'pricing', 'recommendations', 'referral', 'budget', 'privacy', 'credits', 'support', 'blog', 'refund', 'terms', 'cookies', 'founding', 'dice'],
    interpolation: {
      escapeValue: false
    },
    react: {
