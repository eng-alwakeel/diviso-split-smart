-- إصلاح دالة get_group_budget_tracking_v2 لحل مشكلة التحقق من العضوية
...
-- إصلاح trigger auto_link_expense_to_budget ليعمل مع الفئات
...
-- التأكد من وجود trigger على expenses
DROP TRIGGER IF EXISTS auto_link_expense_trigger ON expenses;
CREATE TRIGGER auto_link_expense_trigger
