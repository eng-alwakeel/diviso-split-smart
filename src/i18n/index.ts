...
i18n
  ...
  .init({
    ...
    fallbackLng: 'ar',
    defaultNS: 'common',
    ns: ['common', 'settings', 'auth', 'dashboard', 'expenses', 'groups', 'errors', 'faq', 'quota', 'notifications', 'landing', 'pricing', 'recommendations', 'referral', 'budget', 'privacy', 'credits', 'support', 'blog', 'refund'],
    interpolation: {
      escapeValue: false
    },
    react: {
